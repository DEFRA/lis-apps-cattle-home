...
import { CattleHomeBe4Fe } from '#server/services/cattle-home-be4fe.js'
import { statusCodes } from '@defra/lis-infra-ui-services/status-codes'
import { logger } from '@defra/lis-hubs-infra-core'

const cattleHomeBe4Fe = new CattleHomeBe4Fe(
...
export const landingController = {
  async handler(request, h) {
    ...
    const { data: holdings } = await cattleHomeBe4Fe.getCphsForUser(userId)
